\documentclass[a4paper, twocolumn, 10pt]{article}[23.02.2018]
...
\begin{quotation}
Čím více {\ttfamily druhů,} \textit{\textbf{řezů,}} {\small velikostí}, barev písma {\fontfamily{cmss}\selectfont a~jiných efektů} použijeme, tím \textit{profesionálněji} bude dokument vypadat. Čtenář tím {\tiny bude} vždy \textbf{{\huge nadšen!}}
\end{quotation}
